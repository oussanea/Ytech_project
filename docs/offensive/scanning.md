---
sidebar_label: 'Phase 2 : Scanning et Énumération'
sidebar_position: 2
---
...
![Scan Nmap : Identification des services et versions](./nmap1.PNG)
![Analyse détaillée Nmap : Fingerprinting de l'OS](./nmap2.PNG)
![Rapport final Nmap : Synthèse des ports ouverts](./nmap3.PNG)
...
![Configuration et lancement de Gobuster](./gobuster1.PNG)
![Résultats du scan Gobuster sur l'arborescence](./gobus2.PNG)
...
![Tentative d'accès distant au service MySQL](./mysql.PNG)
