---
sidebar_label: 'Phase 1 : Reconnaissance et Fingerprinting'
sidebar_position: 1
---
...
![Analyse WhatWeb des technologies serveurs](./whatweb.PNG)
...
![Analyse des headers HTTP via Curl](./curl.PNG)
...
![Vérification SSLScan du certificat et des protocoles](./ssl1.PNG)
![Analyse des Cipher Suites acceptées](./ssl2.PNG)
