...
### 4.1 Vérification du statut SSH
...
### 4.2 Activation et démarrage de SSH
...
### 4.3 Récupération de l'adresse IP
...
### 4.5 Pourquoi SSH plutôt que la console directe ?
...
## 6. Installation des Dépendances (PHP, Nginx)
